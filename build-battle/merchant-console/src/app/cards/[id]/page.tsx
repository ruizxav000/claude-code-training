...
import { CardStatusAction } from "./status-action"
...
export default async function CardDetail({
  ...
  const pct = card.spendLimit > 0 ? (card.spend / card.spendLimit) * 100 : 0
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="mt-4">
        <CardStatusAction cardId={card.id} status={card.status} />
      </div>
    </div>
  )
}
